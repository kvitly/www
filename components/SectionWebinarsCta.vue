...
<template>
  <div class="bg-white">
    <div class="max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <h2 class="text-3xl space-y-2 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
        <span class="block">Хотите попробовать 🌱kvitly</span>
        <span class="block">или посмотреть больше видео?</span>
      </h2>
