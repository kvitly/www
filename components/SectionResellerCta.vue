<template>
  <div class="relative py-16 bg-white">
    ...
    <div class="max-w-7xl mx-auto bg-emerald-600 lg:bg-transparent lg:px-8">
      <div class="lg:grid lg:grid-cols-12">
        ...
        <div class="relative bg-emerald-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <svg class="absolute bottom-full left-full transform translate-y-1/3 -translate-x-2/3 xl:bottom-auto xl:top-0 xl:translate-y-0" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
              <defs>
                <pattern id="64e643ad-2176-4f86-b3d7-f2c5da3b6a6d" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                  <rect x="0" y="0" width="4" height="4" class="text-emerald-500" fill="currentColor" />
                </pattern>
              </defs>
          ...
          <div class="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
            <h2 class="text-3xl font-extrabold text-white" id="join-heading">Готовы присоединиться?</h2>
            <p class="text-lg text-white">Пишите нам, и мы найдем самый удобный способ для совместной работы! Мы всегда открыты новым знакомствам и партнерствам.</p>
            <a class="block w-full py-3 px-5 text-center bg-white border border-transparent rounded-md shadow-md text-base font-medium text-emerald-700 hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Стать партнером</a>
          </div>
        </div>
      </div>
    </div>
