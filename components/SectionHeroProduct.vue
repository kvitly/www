    ...
    <div class="relative overflow-hidden">
        ...
        <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div class="text-center">
            <h1 class="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl md:text-6xl">
              <span class="block">{{ props.title[0] }}</span>
              <span class="block text-emerald-500">{{ props.title[1] }}</span>
            </h1>
            <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">{{ props.description }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="relative">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
          <img class="relative rounded-lg shadow-md border border-gray-50 -m-4" :src="props.image.src"
        :alt="props.image.alt" />
        </div>
      </div>
    </div>
