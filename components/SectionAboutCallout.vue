            ...
            <div class="relative rounded-2xl px-6 py-10 bg-emerald-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
              ...
              <div class="relative">
                <div class="sm:text-center">
                  <h2 class="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">Зачем мы это делаем?</h2>
                  <p class="mt-6 mx-auto max-w-3xl text-xl text-emerald-100">
                    Мы верим, что с нами можно экономить время и делать сложные вещи легко. Для этого мы построили сервис, 
                    где в одном месте предприниматели могут создавать сайты для своего дела и автоматизировать бизнес-процессы.
                  </p>
                </div>
              </div>
            </div>
